...
async function verifyWerkbank() {
    const dir = '/Users/thor/WebstormProjects/easyPV/databases/Teil01 Grundlagen/database/BWL/Projektmanagement & Organisation/Erschienene Themen/Fremdvergabe/__02_doing_Fremdvergabe';
    const files = [
        '_g01_fremdvergabe_werkbank.json',
