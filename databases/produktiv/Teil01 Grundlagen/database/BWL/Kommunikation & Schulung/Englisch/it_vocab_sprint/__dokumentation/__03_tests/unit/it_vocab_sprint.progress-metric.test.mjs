...
const jsPath = path.join(topicDir, '_gjs_it_vocab_sprint.js');

describe('IT-Vocab-Sprint Progress Metrics', () => {
  it('exposes measurable score/progress/highscore output for automation and tracking', async () => {
    ...
    assert.match(jsRaw, /highscore\s*:/, 'missing highscore metric in render_game_to_text payload');
