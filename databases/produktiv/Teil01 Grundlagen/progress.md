...
- Dateien erstellt im selben Themenordner:
  ...
  - `_gg01_leasing_gutachter.json`
  - `_gcss_leasing.css` (shared fuer zusammenhaengende Leasing-Prototypen)
...
- Neue Dateien:
  ...
  - `_gg01_finanzierungs_sortiermaschine.json`
- `_gcss_leasing.css` um namespacete Styles fuer Sortiermaschine erweitert.
...
- Neuer Prototyp `GamePlan-Der-Matrix-Architekt.txt` implementiert in:
  ...
  - `database/BWL/Auswahl & Bewertung/Erschienene Themen/Nutzwertanalyse/_gg01_der_matrix_architekt.json`
  - `database/BWL/Auswahl & Bewertung/Erschienene Themen/Nutzwertanalyse/_gcss_nutzwertanalyse.css`
...
- `GamePlan-Der-Deeskalations-Profi.txt` umgesetzt in:
  - `database/BWL/Kommunikation & Schulung/Erschienene Themen/4-Ohren-Modell/_gg01_4ohren_deeskalation.json`
  ...
  - `database/BWL/Kommunikation & Schulung/Erschienene Themen/4-Ohren-Modell/_gcss_kommunikation.css`
